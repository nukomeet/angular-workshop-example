System.config({
  ...
  map: {
    ...
    "npm:koa-common@1.2.0": {
      "koa-compress": "npm:koa-compress@1.0.8",
      "koa-conditional-get": "npm:koa-conditional-get@1.0.3",
      "koa-etag": "npm:koa-etag@1.2.5",
      "koa-favicon": "npm:koa-favicon@1.0.1",
      "koa-logger": "npm:koa-logger@1.2.2",
      "koa-mount": "npm:koa-mount@1.2.5",
      "koa-ratelimit": "npm:koa-ratelimit@1.0.3",
      "koa-response-time": "npm:koa-response-time@1.0.2",
      "koa-rewrite": "npm:koa-rewrite@1.1.1",
      "koa-session": "npm:koa-session@2.0.0",
      "koa-static": "npm:koa-static@1.4.9"
    },
    "npm:koa-compress@1.0.8": {
    ...
    "npm:koa-logger@1.2.2": {
      "bytes": "npm:bytes@1.0.0",
      "humanize-number": "npm:humanize-number@0.0.2",
      "passthrough-counter": "npm:passthrough-counter@0.0.1",
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
    "npm:koa-mount@1.2.5": {
    ...
    "npm:koa-ratelimit@1.0.3": {
      "debug": "npm:debug@0.7.4",
      "ms": "npm:ms@0.6.2",
      "ratelimiter": "npm:ratelimiter@1.0.3",
      "thunkify": "npm:thunkify@0.0.1"
    },
    "npm:koa-rewrite@1.1.1": {
      "debug": "npm:debug@0.7.4",
